...
SECRET_KEY = 'django-insecure-&%dj3e8w0+s*wc$^i)=%!ri1g6l&2nh$vn6#eijpsx*x8)z)+m'
...
ROOT_URLCONF = 'sailoon.urls'
AUTH_USER_MODEL = 'sailoonapp.User'
...
WSGI_APPLICATION = 'sailoon.wsgi.application'
